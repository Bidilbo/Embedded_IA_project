...
for X, y in test_dataloader:
    ...
    plt.savefig("./predictions_fashion_mnist.png")
    break
...
torch.save(model.state_dict(), "model_MLP_MNIST3.pth")
print("Saved PyTorch Model State to model_MLP_MNIST3.pth")

# Loading model
model = ML_Perceptron(input_size, hidden_size, output_size).to(device)
#model = FashionCNN().to(device)
model.load_state_dict(torch.load("model_MLP_MNIST3.pth", weights_only=True))
